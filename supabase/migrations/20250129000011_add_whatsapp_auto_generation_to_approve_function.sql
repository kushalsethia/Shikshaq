-- Migration: Add WhatsApp link auto-generation to approve_teacher_application function
-- Auto-generates WhatsApp link from phone number if not provided
