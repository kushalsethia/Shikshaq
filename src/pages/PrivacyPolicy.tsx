...
const pMtClass = 'max-w-prose text-base text-warm-prose leading-relaxed mt-3';
...
const ulPlainClass = 'max-w-prose text-base text-warm-prose leading-relaxed list-none pl-0 space-y-1';
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: (
      <>
        <p className={pClass}>We use the collected information for the following purposes:</p>
        <ul className={ulClass}>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className={pMtClass}>
          Your Google account data is processed according to <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className={linkClass}>Google's Privacy Policy</a>. We do not have access to your Google password or other Google account data beyond what you authorize.
        </p>

        <h3 className={h3Class}>4.2 Supabase</h3>
        <p className={pClass}>
          We use Supabase as our backend service provider for database storage and authentication. Your data is stored securely on Supabase's servers. Supabase processes your data according to their <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className={linkClass}>Privacy Policy</a> and <a href="https://supabase.com/security" target="_blank" rel="noopener noreferrer" className={linkClass}>Security practices</a>.
        </p>

        <h3 className={h3Class}>4.3 Google Gemini AI</h3>
        <p className={pClass}>
          We use Google Gemini AI to power our chatbot feature. When you interact with the chatbot, your messages are sent to Google's Gemini API to generate responses. Your chat messages are processed according to <a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener noreferrer" className={linkClass}>Google's Gemini API Terms</a>. We do not store your chat conversations permanently.
        </p>

        <h3 className={h3Class}>4.4 Data Sharing</h3>
        <p className={pClass}>We do not sell, trade, or rent your personal information to third parties. We may share your information only in the following circumstances:</p>
        <ul className={ulClass}>
  ...
  },
  {
    ...
    body: (
      <>
        <p className={pClass}>You have the following rights regarding your personal information:</p>
        <ul className={ulClass}>
          ...
          <li><strong>Deletion:</strong> You can request deletion of your account and associated data by contacting us at <a href="mailto:join.shikshaq@gmail.com" className={linkClass}>join.shikshaq@gmail.com</a>.</li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className={pMtClass}>
          If you are a parent or guardian and believe we have collected information from your child without proper consent, please contact us immediately at <a href="mailto:join.shikshaq@gmail.com" className={linkClass}>join.shikshaq@gmail.com</a> or our Grievance Officer (details provided in Section 13).
        </p>
        <p className={pMtClass}>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul className={ulClass}>
          <li><strong>Email:</strong> <a href="mailto:join.shikshaq@gmail.com" className={linkClass}>join.shikshaq@gmail.com</a></li>
          <li><strong>WhatsApp:</strong> <a href="https://wa.me/918240980312" target="_blank" rel="noopener noreferrer" className={linkClass}>+91 8240980312</a></li>
          <li><strong>Website:</strong> <a href="https://www.shikshaq.in" className={linkClass}>www.shikshaq.in</a></li>
        </ul>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Email:</strong> <a href="mailto:krishgoenka96749@gmail.com" className={linkClass}>krishgoenka96749@gmail.com</a></li>
          <li><strong>Phone/WhatsApp:</strong> <a href="https://wa.me/918240980312" target="_blank" rel="noopener noreferrer" className={linkClass}>+91 8240980312</a></li>
