...
const pStyle: CSSProperties = { maxWidth: '66ch', fontSize: 16, lineHeight: 1.7, color: '#4A443E' };
const h3Style: CSSProperties = { fontSize: 16, fontWeight: 700, marginTop: 16, marginBottom: 6, color: '#1F1F1F' };
const ulStyle: CSSProperties = { maxWidth: '66ch', fontSize: 16, lineHeight: 1.7, color: '#4A443E', paddingLeft: 20, listStyleType: 'disc' };
const linkStyle: CSSProperties = { color: '#4351FF', textDecoration: 'underline' };
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p style={pStyle}>We collect information that you voluntarily provide when you:</p>
        <ul style={ulStyle}>
  ...
  },
  {
    ...
    body: (
      <>
        <h3 style={h3Style}>4.1 Google OAuth</h3>
        <p style={pStyle}>
        ...
        <p style={{ ...pStyle, marginTop: 12 }}>
          Your Google account data is processed according to <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" style={linkStyle}>Google's Privacy Policy</a>. We do not have access to your Google password or other Google account data beyond what you authorize.
        </p>

        <h3 style={h3Style}>4.2 Supabase</h3>
        <p style={pStyle}>
          We use Supabase as our backend service provider for database storage and authentication. Your data is stored securely on Supabase's servers. Supabase processes your data according to their <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" style={linkStyle}>Privacy Policy</a> and <a href="https://supabase.com/security" target="_blank" rel="noopener noreferrer" style={linkStyle}>Security practices</a>.
        </p>

        <h3 style={h3Style}>4.3 Google Gemini AI</h3>
        <p style={pStyle}>
          We use Google Gemini AI to power our chatbot feature. When you interact with the chatbot, your messages are sent to Google's Gemini API to generate responses. Your chat messages are processed according to <a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener noreferrer" style={linkStyle}>Google's Gemini API Terms</a>. We do not store your chat conversations permanently.
        </p>

        <h3 style={h3Style}>4.4 Data Sharing</h3>
  ...
  },
  {
    ...
    body: (
      <>
        <p style={pStyle}>You have the following rights regarding your personal information:</p>
        <ul style={ulStyle}>
          ...
          <li><strong>Deletion:</strong> You can request deletion of your account and associated data by contacting us at <a href="mailto:join.shikshaq@gmail.com" style={linkStyle}>join.shikshaq@gmail.com</a>.</li>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p style={{ ...pStyle, marginTop: 12 }}>
          If you are a parent or guardian and believe we have collected information from your child without proper consent, please contact us immediately at <a href="mailto:join.shikshaq@gmail.com" style={linkStyle}>join.shikshaq@gmail.com</a> or our Grievance Officer (details provided in Section 13).
        </p>
        <p style={{ ...pStyle, marginTop: 12 }}>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul style={ulStyle}>
          <li><strong>Email:</strong> <a href="mailto:join.shikshaq@gmail.com" style={linkStyle}>join.shikshaq@gmail.com</a></li>
          <li><strong>WhatsApp:</strong> <a href="https://wa.me/918240980312" target="_blank" rel="noopener noreferrer" style={linkStyle}>+91 8240980312</a></li>
          <li><strong>Website:</strong> <a href="https://www.shikshaq.in" style={linkStyle}>www.shikshaq.in</a></li>
        </ul>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <ul style={ulStyle}>
          ...
          <li><strong>Email:</strong> <a href="mailto:krishgoenka96749@gmail.com" style={linkStyle}>krishgoenka96749@gmail.com</a></li>
          <li><strong>Phone/WhatsApp:</strong> <a href="https://wa.me/918240980312" target="_blank" rel="noopener noreferrer" style={linkStyle}>+91 8240980312</a></li>
