          ...
          {pills.map((pill, i) => {
            ...
            return (
              <span
                key={i}
                className={cn(
                  "pointer-events-auto inline-flex h-[34px] items-center gap-[6px] whitespace-nowrap rounded-full px-[14px] text-[13px] font-extrabold motion-reduce:rotate-0 lg:rotate-0",
